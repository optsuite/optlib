...
-- the bound for a strongly convex function is tighter than a general convex function.
...
-- the equivalent definition of a strongly convex function
...
-- If a function is strongly convex, then it is strictly convex.
