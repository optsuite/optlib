...
// Module: Analysis.Gradient_Decent
// Imports: Init Mathlib.LinearAlgebra.FiniteDimensional Mathlib.Analysis.InnerProductSpace.PiL2 Mathlib.Analysis.Calculus.MeanValue Mathlib.Analysis.Calculus.FDeriv.Basic Mathlib.Analysis.InnerProductSpace.Dual Analysis.Lsmooth Analysis.First_Order
#include <lean/lean.h>
...
lean_object* initialize_Analysis_Lsmooth(uint8_t builtin, lean_object*);
lean_object* initialize_Analysis_First__Order(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Analysis_Gradient__Decent(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Analysis_Lsmooth(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Analysis_First__Order(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
